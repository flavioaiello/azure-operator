...
const testSubscriptionScope = "/subscriptions/sub1"
...
func TestGenerateAssignmentName(t *testing.T) {
	name1 := generateAssignmentName(testSubscriptionScope, RoleContributor, "principal1")
	name2 := generateAssignmentName(testSubscriptionScope, RoleContributor, "principal1")
	name3 := generateAssignmentName(testSubscriptionScope, RoleContributor, "principal2")
...
func TestOperatorConfigDependsOn(t *testing.T) {
	cfg := OperatorConfig{
		Name:      "firewall",
		Domain:    "firewall",
		Roles:     []string{"NetworkContributor"},
